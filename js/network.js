...
if (localStorage.getItem('login') != null) {
    ...
    let out = '';
    out += '<li class="nav-item dropdown" id="user_info"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">' + user.phone_number + '</a><ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink"> <li><a class="dropdown-item btn btn-primary" data-bs-toggle="modal" id="exit">Выйти</a></li></ul></li>'
    ...
    for (let item in appointments) {
        ...
        if (appointments[item].phone_number === username) {
            ...
            if (appointments[item].password !== password) {
                ...
                let modal_user = document.getElementById('modal_user');
                modal_user.innerHTML = '<li class="nav-item dropdown" id="user_info"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">' + appointments[item].phone_number + '</a><ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink"> <li><a class="dropdown-item btn btn-primary" data-bs-toggle="modal" id="exit">Выйти</a></li></ul></li>';
            }
            break;
        }
    }
